...
impl<T: FloatType + Clone + PartialEq> RestrictionsTemplate<T> for Template {
...
impl FloatType for treeldr_primitives::F32 {
	const INFINITY: Self = treeldr_primitives::F32::INFINITY;
	const NEG_INFINITY: Self = treeldr_primitives::F32::NEG_INFINITY;
}

impl FloatType for treeldr_primitives::F64 {
	const INFINITY: Self = treeldr_primitives::F64::INFINITY;
	const NEG_INFINITY: Self = treeldr_primitives::F64::NEG_INFINITY;
}
...
impl<T: FloatType + Clone + PartialEq, M> RestrictionSet for Restrictions<T, M> {

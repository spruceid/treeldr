...
#[tldr(
	"modules/rust/gen/tests/t03.tldr"
)]
pub mod schema {
...
async fn t03() {
	...
	let doc: json_ld::RemoteDocumentReference<IriBuf, Span, _> = json_ld::RemoteDocumentReference::Iri(iri!("https://example.com/t03.jsonld").to_owned());

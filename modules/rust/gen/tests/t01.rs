// cargo run -p treeldr-rust-cli -- -i modules/rust/gen/tests/t01.tldr -m rdfs="http://www.w3.org/2000/01/rdf-schema#" -m xsd="http://www.w3.org/2001/XMLSchema#" -m example="https://example.com/example/" | rustfmt
use iref::IriBuf;
...
#[tldr(
	"modules/rust/gen/tests/t01.tldr"
)]
pub mod schema {
...
async fn t01() {
	...
	let doc: json_ld::RemoteDocumentReference<IriBuf, Span, _> = json_ld::RemoteDocumentReference::Iri(iri!("https://example.com/t01.jsonld").to_owned());
	...
	assert_eq!(value, schema::test::Enum::A(schema::test::A {

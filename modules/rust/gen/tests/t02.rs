// cargo run -p treeldr-rust-cli -- -i modules/rust/gen/tests/t02.tldr -m rdfs="http://www.w3.org/2000/01/rdf-schema#" -m xsd="http://www.w3.org/2001/XMLSchema#" -m example="https://example.com/example/" | rustfmt
use iref::IriBuf;

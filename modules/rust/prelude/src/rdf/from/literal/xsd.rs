...
use super::{FromLiteral, type_check};
...
impl<S: AsRef<str>, T, L, V: IriVocabularyMut<Iri = T>> FromLiteral<Literal<S, T, L>, V> for bool {
	fn from_literal(vocabulary: &V, literal: &Literal<S, T, L>) -> Result<Self, FromRdfError> {
		let lexical = type_check(vocabulary, literal, iri!("http://www.w3.org/2001/XMLSchema#boolean"))?;
...
impl<S: AsRef<str>, T, L, V: IriVocabularyMut<Iri = T>> FromLiteral<Literal<S, T, L>, V> for String {
	fn from_literal(vocabulary: &V, literal: &Literal<S, T, L>) -> Result<Self, FromRdfError> {
		match literal {
...
impl<S: AsRef<str>, T, L, V: IriVocabularyMut<Iri = T>> FromLiteral<Literal<S, T, L>, V> for i64 {
	fn from_literal(vocabulary: &V, literal: &Literal<S, T, L>) -> Result<Self, FromRdfError> {
		let lexical = type_check(vocabulary, literal, iri!("http://www.w3.org/2001/XMLSchema#integer"))?;
...
impl<S: AsRef<str>, T, L, V: IriVocabularyMut<Iri = T>> FromLiteral<Literal<S, T, L>, V> for ::chrono::DateTime<::chrono::Utc> {
	fn from_literal(vocabulary: &V, literal: &Literal<S, T, L>) -> Result<Self, FromRdfError> {
		let lexical = type_check(vocabulary, literal, iri!("http://www.w3.org/2001/XMLSchema#dateTime"))?;

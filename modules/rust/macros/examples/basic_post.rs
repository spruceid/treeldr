...
use treeldr_rust_prelude::{ld::import_grdf_quad, static_iref::iri, FromRdf, IntoJsonLdSyntax};

/// Schema types generated by TreeLDR.
#[tldr(
	"examples/schema.org.tldr",
	"modules/rust/macros/examples/vc.tldr",
	"modules/rust/macros/examples/rebase.tldr",
...
async fn main() {
	...
	vc.type_.extend([
		treeldr_rust_prelude::Id(Term::Id(Id::Iri(
	...
	// Schema to JSON-LD.
	let mut json_ld_out = vc.into_json_ld_syntax(&(), &());

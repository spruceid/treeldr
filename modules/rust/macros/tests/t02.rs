// cargo run -p treeldr-rust-cli -- -i modules/rust/macros/tests/t02.tldr -m rdfs="http://www.w3.org/2000/01/rdf-schema#" -m xsd="http://www.w3.org/2001/XMLSchema#" -m test="https://example.com/" | rustfmt
use iref::IriBuf;

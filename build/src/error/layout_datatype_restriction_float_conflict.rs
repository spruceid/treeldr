...
pub type LayoutDatatypeRestrictionFloatConflict<M> = treeldr::layout::primitive::restriction::float::Conflict<M>;

impl<M: MaybeLocated<Span=Span>> super::AnyError<M> for LayoutDatatypeRestrictionFloatConflict<M> where M::File: Clone {

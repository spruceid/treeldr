...
pub type LayoutDatatypeRestrictionUnsignedConflict<M> = treeldr::layout::primitive::restriction::unsigned::Conflict<M>;

impl<M: MaybeLocated<Span=Span>> super::AnyError<M> for LayoutDatatypeRestrictionUnsignedConflict<M> where M::File: Clone {
